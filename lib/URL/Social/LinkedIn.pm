...
URL::Social::LinkedIn - Interface to the LinkedIn API.
...
Do not use this module directly. Access it from L<URL::Social> instead;
    ...
    print $social->linkedin->share_count . "\n";
...
Returns the number of times the URL in question has been shared among LinkedIn
users.

Returns undef if it fails to retrieve the data from LinkedIn.
